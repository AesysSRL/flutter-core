...
abstract class EntityRepository<I extends Model, O extends Model> extends Repository<I, O> {
...
Future<Either<AppError, I>> get<T>(T id);

Future<Either<AppError, I>> insert(O model);

Future<Either<AppError, I>> edit(O model);

Future<Either<AppError, DeletionModel>> delete<T>(T id);
}
